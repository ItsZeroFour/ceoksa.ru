        ...
        <div className={style.policy__wrapper}>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                10.3 — Обработка персональных данных необходима для
              ...
              <li>
                10.5 — Обработка персональных данных необходима для
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                11.5 — Вся информация, которая собирается сторонними сервисами,
          ...
          <section>
            ...
            <ul>
              <li>
                12.1 — Оператор осуществляет сбор, запись, систематизацию,
                накопление, хранение, уточнение (обновление, изменение),
                извлечение, использование, передачу (распространение,
              ...
              <li>
                12.2 — Оператор осуществляет автоматизированную обработку
          ...
          <section>
            ...
            <ul>
              <li>
                13.1 — Оператор до начала осуществления трансграничной передачи
              ...
              <li>
                13.2 — Трансграничная передача персональных данных на территории
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                ...
                расположена в сети Интернет по адресу https://ceoksa.ru/.
              </li>
            </ul>
          </section>
        </div>
