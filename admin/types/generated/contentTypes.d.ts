...
export interface ApiLuchshiePredlozheniyaLuchshiePredlozheniya
  extends Struct.SingleTypeSchema {
  collectionName: 'luchshie_predlozheniyas';
  info: {
    displayName: '\u041B\u0443\u0447\u0448\u0438\u0435 \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u0435\u043D\u0438\u044F';
    pluralName: 'luchshie-predlozheniyas';
    singularName: 'luchshie-predlozheniya';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    cards: Schema.Attribute.DynamicZone<['cards-banks.kartochki-bankov']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::luchshie-predlozheniya.luchshie-predlozheniya'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiPreimushhestvaPreimushhestva
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    advantages: Schema.Attribute.DynamicZone<['advantages.preimushhestva']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiShapkaShapka extends Struct.SingleTypeSchema {
  collectionName: 'shapkas';
  info: {
    displayName: '\u0428\u0430\u043F\u043A\u0430';
    pluralName: 'shapkas';
    singularName: 'shapka';
