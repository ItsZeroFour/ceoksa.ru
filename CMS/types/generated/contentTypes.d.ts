...
export interface ApiFajlyFajly extends Struct.SingleTypeSchema {
  collectionName: 'fajlies';
  info: {
    displayName: '\u0424\u0430\u0439\u043B\u044B';
    pluralName: 'fajlies';
    singularName: 'fajly';
  ...
  attributes: {
    agreement_on_the_use_of_a_simple_electronic_signature: Schema.Attribute.Media<
      'images' | 'files'
    >;
    consent_to_receive_advertising: Schema.Attribute.Media<'images' | 'files'>;
    consent_to_the_processing_of_personal_data: Schema.Attribute.Media<
      'images' | 'files'
    >;
    consent_to_the_processing_of_personal_data_by_telecom_operators: Schema.Attribute.Media<
      'images' | 'files'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::fajly.fajly'> &
      Schema.Attribute.Private;
    polzovatelskoe_soglashenie: Schema.Attribute.Media<'files' | 'images'>;
    privacy_policy: Schema.Attribute.Media<'images' | 'files'>;
    publishedAt: Schema.Attribute.DateTime;
    terms_of_information_transfer: Schema.Attribute.Media<'images' | 'files'>;
    terms_of_transfer_of_informationconsent: Schema.Attribute.Media<
      'images' | 'files'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
